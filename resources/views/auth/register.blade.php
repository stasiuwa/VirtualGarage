...
@section('content')
        <form method="POST" action="{{ route('register') }}">
            ...
            <div style="width: 100%">
                <input style="margin-left: 10vw;" class="form-check-input" type="checkbox" value="" id="flexCheckDefault" name="terms" required>
                <label class="form-check-label" for="flexCheckDefault">
                    Akceptuję <a style="color: lightgoldenrodyellow" href="{{ url("/termsofuse.pdf") }}" target="_blank">regulamin użytkowania</a>
                </label>
            </div>
